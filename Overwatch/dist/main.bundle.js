        ...
        this.sub = this.route.params.subscribe(function (params) {
            ...
            _this.httpClient.get('http://hpk-overwatch-func.azurewebsites.net/api/PropertyRetrieval?propertyId=' + _this.id).subscribe(function (data) {
                ...
                if (_this.detail.latestPropertyAlert) {
                    ...
                    _this.predictions = [];
                    var parsingPredictions = JSON.parse(_this.detail.latestPropertyAlert.predictionJson);
                    for (var _i = 0, parsingPredictions_1 = parsingPredictions; _i < parsingPredictions_1.length; _i++) {
                        var prediction = parsingPredictions_1[_i];
                        _this.predictions.push({
                            'tag': prediction.Tag,
